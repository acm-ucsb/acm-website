    ...
    >
        <Card
            sx={{
                ...
                boxShadow: activeFilter === -1?"0 4px 20px rgba(0, 0, 0, 0.2)":"0 2px 10px rgba(0, 0, 0, 0.08)",                m: 2,
                display: "flex",
        ...
        {branchData.map((branchItem) => (
           <div key={branchItem.id} onClick={()=>handleFilter(branchItem.id)}> <Card
            sx={{
                borderRadius: '4px',
                m: 2,
                backgroundColor: activeFilter === branchItem.id? "#f0f0f0":'#ffffff',
                transform: activeFilter === branchItem.id? 'scale(1.05)':'scale(1.0)',
                boxShadow: activeFilter === branchItem.id?"0 4px 20px rgba(0, 0, 0, 0.2)":"0 2px 10px rgba(0, 0, 0, 0.08)",
