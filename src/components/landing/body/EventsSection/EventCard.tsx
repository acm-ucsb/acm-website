    ...
    >
      <CardContent sx={{ padding: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "16px" }}>
          ...
          <Typography
            variant="caption"
            sx={{ color: "#999", fontWeight: 500, fontSize: "0.75rem", letterSpacing: "0.05em" }}
          >
            {weekday}
          </Typography>
        </div>
        ...
        {/* Location */}
        <Typography variant="body2" sx={{ color: "#444", marginBottom: "2px" }}>
          {event.location ?? "TBD"}
        </Typography>
      ...
      >
        ...
        >
          ...
          <IconButton
            ...
            sx={{ position: "absolute", top: "12px", right: "12px", color: "#888" }}
          >
            <CloseIcon />
          </IconButton>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: "8px", marginBottom: "12px" }}>
            ...
            <Typography variant="caption" sx={{ color: "#999", fontWeight: 500, letterSpacing: "0.05em" }}>
              {weekday}
            </Typography>
          </div>
          ...
          <Typography
            variant="h6"
            sx={{ fontWeight: "bold", color: branch.branchColors[2], marginBottom: "16px" }}
          >
            {event.name}
          </Typography>

          {/* Description only appears in the popup, not on the card */}
          <Typography variant="body1" sx={{ color: "#444", marginBottom: "20px", lineHeight: 1.6 }}>
