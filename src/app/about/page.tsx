      ...
      <div className="flex flex-col align-center">
        <Container maxWidth="md">
          ...
          >
            ...
            >
              <div
                className={`${PageStyles.arrow} ${PageStyles.arrowsecond}`}
              ></div>
              <div
                className={`${PageStyles.arrow} ${PageStyles.arrowfirst}`}
              ></div>
            </Box>
            ...
            <Typography>
              The best way to get involved is to join our Discord server, where
              we post information about events in the announcements channel.
            </Typography>
